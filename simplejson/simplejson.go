...
// this package is forked from https://github.com/bitly/go-simplejson
...
func (j *JSON) MarshalString() string {
	...
	return util.BytesToString(must.Byte(j.MarshalJSON()))
}
...
// New returns a pointer to a new, empty `JSON` array
func NewArray() *JSON {
	return &JSON{
